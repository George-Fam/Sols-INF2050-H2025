...
public class TextDatabase {
  ...
  private File db = new File("/Users/schieder/Desktop/studentdb.txt");

  public TextDatabase() {
    // verify file exists
    if(!db.exists()) {
      throw new RuntimeException("Student DB does not exists. Makes sure the file \"studentdb.txt\" exists and matches the path specified in line 20.");
    }
  }
